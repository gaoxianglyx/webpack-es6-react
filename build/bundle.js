...
/******/ 	var hotCurrentHash = "3274c217099ac81d74da"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helloJs = __webpack_require__(199);
	...
	var App = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement('div', { className: 'nav' }, _react2['default'].createElement(_reactRouter.Link, { to: 'app', className: 'homelink' }, _react2['default'].createElement('h2', null, 'Home'), '  '), _react2['default'].createElement(_reactRouter.Link, { to: 'hello', className: 'hellolink' }, '  Say Hello'), _react2['default'].createElement(_reactRouter.RouteHandler, null));
	  }
	});
